...
function AuthLayout() {
  return (
    <div className="flex min-h-screen w-full bg-[#041b3a] text-blue-50">
      ...
      <div className="flex flex-1 items-center justify-center bg-[#041b3a] px-4 py-12 sm:px-6 lg:px-8">
        <div className="relative w-full max-w-md">
          <div
            aria-hidden="true"
            className="absolute inset-0 rounded-[28px] bg-blue-900/30 blur-3xl"
          />
          <div className="relative rounded-[28px] border border-blue-900/60 bg-[#0a1f3f]/95 p-10 shadow-[0_40px_80px_-20px_rgba(5,15,32,0.85)] backdrop-blur">
            <Outlet />
          </div>
        </div>
      </div>
